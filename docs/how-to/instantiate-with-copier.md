...
```bash
uvx copier copy gh:attested-delivery/attested-pipeline-template my-project
# or: pipx install copier && copier copy gh:attested-delivery/attested-pipeline-template my-project
cd my-project
```
