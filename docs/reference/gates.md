...
| SAST verdict | `reusable-attest-scan.yml` (seam) | `https://attested-delivery.github.io/attestations/sast/v1` |
| SCA verdict | `reusable-attest-scan.yml` (seam) | `https://attested-delivery.github.io/attestations/sca/v1` |
| IaC/license verdict | `reusable-attest-scan.yml` (seam) | `https://attested-delivery.github.io/attestations/iac-license/v1` |
...
Trigger: `workflow_dispatch` only. Requires a running target URL (`target` input; defaults to `https://attested-delivery.github.io`).
...
Predicate: `https://attested-delivery.github.io/attestations/dast/v1` (seam-signed).
